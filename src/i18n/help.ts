...
export const helpTexts = {
  de: {
    ...
    'help.greenhouse': [
      ...
      '4. Ist eine Kreuzung reif, im Gewächshaus „Beanspruchen“ klicken — das Kind ist gesichert.',
  ...
  en: {
    ...
    'help.greenhouse': [
      ...
      '4. When a cross is mature, hit “Claim” in the greenhouse — the child is secured.',
      'Note: The queue holds only 12 crosses. Claim first, then sow again!',
    ].join('\n'),
  },
} as const;
