...
export const tutorialTexts = {
  de: {
    ...
    'tut.pflanzen.text': [
      ...
      'Ziel ist eine freie Zelle: nicht auf den Weg, nicht in einen Findling, nicht in deine Nachbarpflanze. Grüner Umriss heißt ja, roter heißt nein — und ich mache dabei das enttäuschte Gesicht, das habe ich trainiert.',
      'Und der Unterschied zu jedem anderen Beet, das du kennst: Hier baust du nicht auf einem fertigen Weg. Du baust den Weg. Der Umriss entscheidet also nicht nur, WO etwas steht, sondern wie die Biester später laufen.',
    ].join('\n'),
    ...
    'tut.bau.text': [
      ...
      'Was du baust, bleibt: Tiles, Findlinge und Deko sind Besitz. Der nächste Lauf startet auf genau dieser Karte — mit allem, was du heute hingestellt hast. Deshalb heißt es nicht „Level", sondern „dein Beet".',
    ...
    'tut.welle.text': [
      'Die Pflanze steht, also kommen die Gäste: klein, hungrig, ohne Termin, ohne Manieren. Sie laufen den Weg, den DU gebaut hast — jeder Umweg ist gewonnene Zeit für deine Pflanzen.',
  ...
  en: {
    ...
    'tut.pflanzen.text': [
      ...
      'Aim for a free cell: not the path, not a boulder, not your neighbouring plant. Green outline means yes, red means no — and I make the disappointed face, I practised it.',
    ...
    'tut.bau.text': [
      ...
      'What you build stays: tiles, boulders and decor are property. The next run starts on exactly this map — with everything you put down today. That is why it is not a “level”, it is your bed.',
