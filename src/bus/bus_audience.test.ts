...
const SAMPLES: { [K in EventType]: EventPayloads[K] } = {
  ...
  PROJECTILE_FIRED: { projectileId: 'pr1', plantId: 'p1', targetId: 'e1', damage: 15, effectId: null, px: 2.5, py: 4.5 },
  ...
  TILE_PLACED: { gx: 3, gy: 3, tile: 'pot' },
  TILE_REJECTED: { gx: 0, gy: 3, tile: 'decor', reason: 'out_of_world' },
  TILE_REMOVED: { gx: 0, gy: 3, tile: 'decor' },
