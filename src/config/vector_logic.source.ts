...
/** 72er Cos/Sin-Tisch für Attraktor-Rotation — gebackene Literale, kein sin/cos in Source/Sim (Gate). */
export const VECTOR_DIR_TABLE: readonly { dx: number; dy: number }[] = [
  { dx: 1.0000, dy: 0.0000 },
  { dx: 0.9962, dy: 0.0872 },
  { dx: 0.9848, dy: 0.1736 },
  { dx: 0.9659, dy: 0.2588 },
