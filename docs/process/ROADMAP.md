...
| P-5 | **GEMESSEN (23.09.2026): Krix-Blase auf 390×844.** E2E-Nachmessung an der heutigen Fläche (`tests/krix_bubble.spec.ts`, Tour explizit erzwingbar über `?tutorial=1`, DevGate): die sichtbare Blase liegt vollständig im Viewport und überdeckt KEINE Tray-Karte — auch nach der P-25-Tray-Umsiedlung. Vertrag bleibt als Regression gebunden. | `components/tutorial/`, `tests/krix_bubble.spec.ts` | `components/` |
