...
1. **F6 (3/3, eskaliert)** — verdeckte Zonen → Echtgeld-Käufe — STATUS: erledigt (DEV 63222e5, 2026-09-18)
2. **Q16 (3/3)** — Hold schluckt Brett-Taps lautlos — STATUS: erledigt (DEV 63222e5, 2026-09-18 — Hold ruht nur die Sim, Command-Flush vor dem Brett-Tap)
3. **Q17 (3/3)** — pressed-Zombie + fehlendes no_inventory-Feedback (Fix-Richtung konkretisiert) — STATUS: erledigt (DEV 63222e5, 2026-09-18 — Tap auf eigene ×0-Karte bricht ab, letzte Einheit löst Auswahl)
